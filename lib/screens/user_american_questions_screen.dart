...
class _UserAmericanQuestionsScreenState extends State<UserAmericanQuestionsScreen> {
  ...
  void create_question_widget() {
    ...
    child:FlatButton(
            ...
            child: Text(answer_option_1, style: TextStyle(color: Colors.black, fontSize: 20),),
    ...
    child:FlatButton(
            ...
            textColor: Colors.black,
            padding: EdgeInsets.fromLTRB(10, 10, 10, 10),
            child: Text(answer_option_2, style: TextStyle(color: Colors.black, fontSize: 20),),
            shape: RoundedRectangleBorder(side: BorderSide(
              color: Colors.lightBlueAccent,
              width: 2,
              //style: BorderStyle.solid
    ...
    child:FlatButton(
            ...
            textColor: Colors.black,
            padding: EdgeInsets.fromLTRB(10, 10, 10, 10),
            child: Text(answer_option_3, style: TextStyle(color: Colors.black, fontSize: 20),),
            shape: RoundedRectangleBorder(side: BorderSide(
              color: Colors.lightBlueAccent,
              width: 2,
              //style: BorderStyle.solid
    ...
    child:FlatButton(
            ...
            textColor: Colors.black,
            padding: EdgeInsets.fromLTRB(10, 10, 10, 10),
            child: Text(answer_option_4, style: TextStyle(color: Colors.black, fontSize: 20),),
            shape: RoundedRectangleBorder(side: BorderSide(
              color: Colors.lightBlueAccent,
              width: 2,
              //style: BorderStyle.solid
